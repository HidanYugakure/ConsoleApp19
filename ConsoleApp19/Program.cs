...
//        break;
//    }
//    else if (result.Length < 3 && result.Length > 3)
//    {
//        Console.WriteLine("Dogru ededi daxil et.....");
//        result = Console.ReadLine();
//    }
...
//string result3= num3.ToString();
//while(true)
//{
//    if (result3.Length == 5)
//    {
//        double outcome = ((num3 * 18) / 100);
...
//while (true)
//{
//    if (result1.Length == 4 && result2.Length == 7)
//    {
//        double outcome1 = ((num1 * 4) / 100);
//        double outcome2 = ((num2 * 9) / 100);
//        double outcome3 = outcome1 + outcome2;
//        double outcome4 = ((outcome3 * 10) / 100);
...
//while (true)
//{
//    if (result1.Length == 6 && result2.Length == 6 && result3.Length == 6)
//    {
//        double outcome = ((num1 * 10) / 10);
//        double outcome2 = ((num2 * 10) / 100);
//        double outcome3 = ((num3 * 10) / 100);
//        double outcome4= outcome+outcome2+outcome3;
//        double outcome5 = ((outcome4 * 10) / 100);
//        Console.WriteLine(outcome5);
//        break;
//    }
//    else
//    {
//        Console.WriteLine("Dogru ededleri daxil edin");
//        result1 = Console.ReadLine();
//        result2 = Console.ReadLine();
...
//while (true)
//{
//    if (result1.Length == 4 && result2.Length == 4 && result3.Length == 4)
//    {
//        double outcome = ((num1 * 1) / 10);
//        double outcome2 = ((num2 * 2) / 100);
//        double outcome3 = ((num3 * 3) / 100);
//        double outcome4 = outcome - outcome2 - outcome3;
//        double outcome5 = ((outcome3 * 7) / 100);
//        double outcome6 = outcome5 + outcome4;
//        Console.WriteLine(outcome6);
//        break;
//    }
//    else
//    {
